...
const BookCard = ({ book }) => {
    return (
        <Link
            href={`/store/${book.id}`}>
            <div className="flex flex-col w-[350px] items-center rounded-xl bg-gray-50 p-2 m-2 shadow-sm">
                <div className="flex p-4">
                    <h3 className="ml-2 text-sm font-medium">{book.title}</h3>
                </div>
                <div className="mb-2 h-13">
                    <Image
                        className="mr-2 rounded-md hover:scale-110"
                        src={book.cover}
                        alt={book.title}
                        width={150}
                        height={100}
                ...
                <div className="flex flex-col justify-around truncate rounded-xl bg-white px-4 py-8 w-full text-xs">
                    <div className="flex justify-around">
                        ...
                        <div className="flex">
                            <HiOutlineCurrencyBangladeshi className="w-5 h-5 mr-0.5" />
